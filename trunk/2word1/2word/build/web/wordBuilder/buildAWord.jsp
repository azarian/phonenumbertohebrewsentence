...
<html>
    ...
    <table width="936" height="711" border="0">
                                <tr id="rG1">
                                    <td height="112" colspan="4"><img src="..\images\BGImages\barUp.gif" width="906" height="110" longdesc="..\images\BGImages\barUp.gif" /></td>
                                </tr>
                                <tr id="rG2">
                                    <td height="31" colspan="4">
                                        <input name="text" type="text" id = outText dir='rtl' lang='he' size = 42 caption = "result:" xml:lang='he'></input>                                    </td>
                              </tr>
                                <tr id="rG3">
                                 ...
                                 <tr id="rG4">
                                        <td height="119" colspan="4"><img src="..\images\BGImages\barDown.gif" width="906" height="110" longdesc="..\images\BGImages\barDown.gif" /></td>
                                </tr>
	</table>
    </body>
    </div>
